...
const Hero = () => {
  return (
    <section className="container mx-auto flex flex-col items-center justify-center gap-2 px-5 py-5 sm:gap-4 lg:px-10 lg:py-10">
      ...
      <button
        type="button"
        className="group mt-4 flex cursor-pointer items-center gap-1 rounded-full border border-white/80 bg-cyan-300 px-3 py-2 text-sm font-semibold text-black/90 sm:px-4 sm:py-3"
      >
        Sign Up for Free
        <ArrowRight
